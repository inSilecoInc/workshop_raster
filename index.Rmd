...
.instructors[
  ...
  [`r rfa("database")`](https://github.com/inSilecoInc/workshop_raster/raw/main/data_and_script.zip)
...
```{R sol1aa, cache = TRUE, include = FALSE}
# raster 
...
```{R sol1ab, cache = TRUE, include = FALSE}
# stars 
...
```{R sol1ba, cache = TRUE, include = FALSE}
# raster 
...
```{R sol1bb, cache = TRUE, include = FALSE}
# stars
...
```{R sol1c, cache = TRUE, include = FALSE}
...
```{R sol2ba1, cache = TRUE, include = FALSE}
# raster
...
```{R sol2ba2, cache = TRUE, fig.width = 7, include = FALSE}
...
```{R sol2ba3, cache = TRUE, fig.width = 7, include = FALSE}
...
```{R sol2bb2, cache = TRUE, fig.width = 7, include = FALSE}
...
```{R sol2bb3, cache = TRUE, fig.width = 7, include = FALSE}
...
```{R sol3aa, cache = TRUE, include = FALSE}
# raster 
rar_m <- mask(rar, stl)
mean(ras_m[[1]], na.rm = TRUE)
```

```{R sol3ab, cache = TRUE, include = FALSE}
# stars 
ras_m <- ras[stl]
mean(ras_m[[1]], na.rm = TRUE)
```
...
```{R sol3b0, cache = TRUE, include = FALSE}
plot(rar)
...
```{R sol3b1, cache = TRUE, include = FALSE}
# raster 
rar_m <- mask(rar, stl)
...
```{R sol3b1b, cache = TRUE, fig.width = 7.5, echo = -1, include = FALSE}
...
```{R sol3b1c, cache = TRUE, include = FALSE}
mean(values(rar_river), na.rm = TRUE)
mean(values(rar_gulf), na.rm = TRUE)
```
...
```{R sol3b2, cache = TRUE, include = FALSE}
# stars 
ras_m <- ras[stl]
