...
```{R sol2ba2, cache = TRUE, fig.width = 7}
...
```{R sol2ba3, cache = TRUE, fig.width = 7}
...
```{R sol2bb2, cache = TRUE, fig.width = 7}
...
```{R sol2bb3, cache = TRUE, fig.width = 7}
...
```{R sol3b1b, cache = TRUE, fig.width = 7.5, echo = -1}
...
![https://github.com/mtennekes/tmap](img/tmp)
