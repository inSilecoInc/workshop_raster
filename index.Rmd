...
> Raster files are grids of equally sized cells (or pixels) that all have a value (or a missing value) for one single variable. 
...
- commonly used to represent continuous phenomenon (e.g. temperature, elevation)
and images (airborne or satellite imagery)
...
- Programming / Coding allows one to automate what you frequently do
...
- Increase efficiency: 
  - 
  - allows you to spend more time thinking 
...
### 1. The package ecosytem is diverse, actively developed 

--

### 2. Community behind is wide, active...

--

### 3. Community behind is wide, active...
...
Depends on [`sf`](https://CRAN.R-project.org/package=sf), `stars` and `sf` are [Tidyverse](https://www.tidyverse.org/) friendly.
