...
- `r icon::fontawesome("star")` Compute the mean depth of the St-Layrence (Gulf and river)
...
- [`ggplot2`](https://CRAN.R-project.org/package=ggmap) `r icon::fontawesome("check")`
