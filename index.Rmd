...
- Same extend/ resolution

- Multi-band raster (satellite images)

- Convenient to apply to a set 
...
```{R, rar_stc}
rar_stc <- stack(list(bath_v1 = rar, bath_v2 = rar2))
class(rar) 
plot(rar_stc)   
```
